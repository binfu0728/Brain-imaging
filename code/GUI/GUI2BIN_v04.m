...
for i = 1:length(names)
    ...
    makeDir(fullfile(newFolder,strrep(filename_only,'.tif','\')));
    ...
    writetable(boundaries,fullfile(newFolder,strrep(filename_only,'.tif','\'), strrep(filename_only,'.tif', '_large_aggregates.csv')));
    end
    ...
    writetable(result_oligomer,fullfile(newFolder,strrep(filename_only,'.tif','\'), strrep(filename_only,'.tif', '_small_aggregates.csv')));
    end
