...
uicontrol('parent',Preprocessing_panel,'style','text','position', [.00  .75 1.0 .1],'string','Strcture:\Project\Round\Sample\Sample_position');     
...
%     drawnow;
    ...
    movefile(filedir(1:end-1),[filedir(1:end-1),'_ori']); %copy original data to the new folder
    if isempty(T)
        ...
        for i = 1:length(filenames)
            ...
            filename    = strrep(filenames{i},filedir,[filedir(1:end-1),'_ori\']);
