...
settings.analysis_group = uibuttongroup('Visible','on','Position',[0 .35 1 .1],'parent',Preprocessing_panel,'SelectionChangedFcn',{@slice_selection_method,'preprocessing'}); 
...
settings.plotmask = uicontrol('parent',Analysis_panel,'style','checkbox','position', [.00  .6 1.0 .05],'string','Visualize mask','callback',{@slice_selection_method,'analysis'}); 
...
function slice_selection_method(~,~,name)
    switch name
        case 'preprocessing'
