function [fov,inCell,outCell,percentage,outPoints,inout] = calcDensity_old(cell_mask,oligPoints,plot,width)
...
%          inout, the extra column labelling whether each object is inside or outise
        width = 2048;
