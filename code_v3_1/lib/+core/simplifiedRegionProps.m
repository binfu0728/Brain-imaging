...
% simplified version of regionprops
% input  : BW, binary mask
%          imsz, size of an image
% 
% output : pixelIdxList, pixel indice list for each binary object
%          areas, number of pixel detected for each binary object
%          centroids, centroid for each binary object
% 
